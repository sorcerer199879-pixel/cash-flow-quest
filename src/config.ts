...
export const ACTIONS: PlayerAction[] = [
  ...
  a({id:"hire",name:"人材を採用する",category:"cost",ap:2,cashCost:30*MAN,risk:"中",duration:8,delay:1,description:"固定費と将来の販売力が増える。",effect:{fixedCostChange:22*MAN,revenueMultiplier:.10,growthChange:.006}}),
  a({id:"cut-staff",name:"人員を削減する",category:"cost",ap:2,cashCost:45*MAN,risk:"高",duration:8,delay:0,description:"一時費用を払い、固定費を圧縮する。",effect:{fixedCostChange:-18*MAN,revenueMultiplier:-.07,creditChange:-2}}),
  ...
  a({id:"equipment",name:"設備を購入する",category:"investment",ap:2,cashCost:0,risk:"中",duration:10,delay:1,description:"今の現金を将来の生産力へ振り替える。",effect:{capex:120*MAN,revenueMultiplier:.12,variableCostRateChange:-.025,growthChange:.004}}),
  a({id:"system",name:"システムを導入する",category:"investment",ap:2,cashCost:0,risk:"低",duration:10,delay:1,description:"設備投資で固定費とミスを減らす。",effect:{capex:75*MAN,fixedCostChange:-7*MAN,variableCostRateChange:-.01}}),
...
export const EVENTS: GameEvent[] = [
  ...
  {id:"late-payment",title:"入金遅延",description:"取引先の支払いが1か月遅れます。",probability:.15,effect:{receivableMonthsChange:1},duration:2,lesson:"利益があっても、回収までは現金ではありません。"},
  ...
  {id:"breakdown",title:"設備トラブル",description:"修繕と一時的な生産低下が発生。",probability:.09,minMonth:4,effect:{fixedCostChange:35*MAN,revenueMultiplier:-.12},duration:1,lesson:"安全余裕は予期せぬ支出への保険です。"},
